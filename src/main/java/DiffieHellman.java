 ...
 *  1. Вибираємо випадковим чином приватні ключі для Аліси та Боба:
 *      privateKey
 *  2. Обчислюємо публічні ключі на основі приватних ключів:
 *      publicKey
 *  3. Обмінюємось ключами та знаходимо спільні ключі методом:
 *  getSharedSecret()
 */
